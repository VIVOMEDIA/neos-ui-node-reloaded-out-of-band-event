...
/***/ "./node_modules/@neos-project/neos-ui-extensibility/src/shims/neosProjectPackages/neos-ui-guest-frame/index.js":
/*!*********************************************************************************************************************!*\
  !*** ./node_modules/@neos-project/neos-ui-extensibility/src/shims/neosProjectPackages/neos-ui-guest-frame/index.js ***!
  \*********************************************************************************************************************/
/*! no static exports found */
...
var _neosUiGuestFrame = __webpack_require__(/*! @neos-project/neos-ui-guest-frame */ "./node_modules/@neos-project/neos-ui-extensibility/src/shims/neosProjectPackages/neos-ui-guest-frame/index.js");
...
(0, _neosUiExtensibility2.default)('VIVOMEDIA.NeosUI.NodeChangedEvent:NodeChanged', {}, function (globalRegistry) {
    ...
    serverFeedbackHandlers.set('Neos.Neos.Ui:ReloadContentOutOfBand/Main', function (feedbackPayload, _ref) {
        var store = _ref.store,
            globalRegistry = _ref.globalRegistry;


        reloadContentOutOfBand(feedbackPayload, { store: store, globalRegistry: globalRegistry });

        var nodeDomAddress = feedbackPayload.nodeDomAddress;

        var domNode = nodeDomAddress && (0, _neosUiGuestFrame.findNodeInGuestFrame)(nodeDomAddress.contextPath, nodeDomAddress.fusionPath);

        (0, _neosUiGuestFrame.dispatchCustomEvent)('Neos.NodeReloadedOutOfBand', 'Node was reloaded out of band.', {
            element: domNode
        });
    });
});
